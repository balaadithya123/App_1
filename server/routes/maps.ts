...
const KNOWN_CITIES = [
  ...
  { city: "Sriperumbudur", state: "Tamil Nadu", lat: 12.9675, lng: 79.9405 },
  { city: "Kanchipuram", state: "Tamil Nadu", lat: 12.8342, lng: 79.7036 },
  { city: "Tambaram", state: "Tamil Nadu", lat: 12.9249, lng: 80.1000 },
  { city: "Avadi", state: "Tamil Nadu", lat: 13.1147, lng: 80.0982 },
