  ...
  return (
    <main className="min-h-screen bg-[#f8faf9] px-5 pb-10 text-ink sm:px-8">
      <div className="mx-auto max-w-[720px]">
        ...
        <Link
          to={backTo}
          className="mb-6 inline-flex items-center gap-1.5 text-[13px] font-bold text-teal transition-colors hover:text-navy focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal focus-visible:ring-offset-2"
        >
          <ArrowLeft size={16} />
          {backLabel}
        </Link>
