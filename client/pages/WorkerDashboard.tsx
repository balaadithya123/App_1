...
export default function WorkerDashboard() {
  ...
  if (loading) return <PageShell backTo="/" backLabel="Home"><section className="rounded-[18px] border border-line bg-white p-8 text-center dark:border-white/10 dark:bg-black"><p className="text-sm text-slate dark:text-slate-300">Loading your dashboard...</p></section></PageShell>;
  if (!user) return null;
