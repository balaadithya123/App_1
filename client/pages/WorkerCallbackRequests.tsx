                      ...
                      className={`rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide ${
                        request.status === "new"
                          ...
                          : request.status === "contacted"
                            ? "border border-primary-100/60 bg-primary-100/10 text-primary"
                ...
                <div className="mt-3.5 flex flex-wrap items-center justify-between gap-2 border-t border-border/70 pt-3">
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      className="inline-flex h-8 items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-500/20 cursor-pointer shadow-subtle"
                    >
